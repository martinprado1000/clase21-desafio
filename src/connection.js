...
db.once("open", _ => {
  console.log("Sistema conectado a la base dbAtlas"); // Cuando se establece la coneccion ejecuto esto
});
...
db.on("error", (err) => {
  ...
  console.log("Error al conectar con la base"); // Cuando se establece la coneccion ejecuto esto
